...
Shader "Time of Day/Cloud Layer (Mobile)"
{
    Properties
    {
        // Parameters
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(appdata_base v) {
                ...
                o.color.a   = _LightColor.a * _CloudDensity * pow(vertnorm.y, 0.5);
            ...
            fixed4 frag(v2f i) : COLOR {
                ...
                // Write results
                color.a *= cloud_alpha * _CloudDensity; // pow(cloud_alpha, _CloudSharpness) * _CloudDensity;
